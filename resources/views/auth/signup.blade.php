                        ...
                        <div class="col-md-4 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-black text-dark display-6">S'enregistrer</h3>
                                    <p class="mb-0">Heureux de vous connaitre !</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="sign-up">
                                        ...
                                        <div class="mb-3">
                                            <input type="email" id="email" name="email" class="form-control"
                                                placeholder="Entrez votre addresse mail" value="{{old("email")}}" aria-label="Email"
                                        ...
                                        <div class="mb-3">
                                            <input type="password" id="password" name="password" class="form-control"
                                                placeholder="Entrez votre mot de passe" aria-label="Password"
                                        ...
                                        <label>Profil</label>
                                        <div class="mb-3">
                                            <input type="texte" id="profil" name="profil" class="form-control"
                                                placeholder="Veillez renseigner un profil" aria-label="Password"
                                                aria-describedby="profil-addon">
                                        </div>
                                        <div class="form-check form-check-info text-left mb-0">
                                            <input class="form-check-input" type="checkbox" name="terms"
                                                id="terms" required>
                                            <label class="font-weight-normal text-dark mb-0" for="terms">
                                                J'acceptes les<a href="javascript:;"
                                                    class="text-dark font-weight-bold">Termes et Conditions</a>.
                                            </label>
                                            @error('terms')
                                                <span class="text-danger text-sm">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-dark w-100 mt-4 mb-3">S'enregistrer</button>
                                            <button type="button" class="btn btn-white btn-icon w-100 mb-3">
                                                <span class="btn-inner--icon me-1">
                                                    <img class="w-5" src="../assets/img/logos/google-logo.svg"
                                                        alt="google-logo" />
                                                </span>
                                                <span class="btn-inner--text">S'enregister avec Google</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
