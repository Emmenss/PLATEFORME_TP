<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">NOM PLATEFORME</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('wallet') ? 'active' : '' }} " href="{{ route('wallet') }}">
                    ...
                    <span class="nav-link-text ms-1">Mes formations</span>
                </a>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item border-start my-0 pt-2">
                ...
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2"> Gestion du Compte </span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('users-management') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Management plateforme</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                ...
                <form method="POST" action="{{ route('logout') }}">
                   ...
                   href="login" onclick="event.preventDefault();
